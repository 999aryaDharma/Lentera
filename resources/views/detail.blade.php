...
<div class="flex font-sans mt-60 ml-96 mb-14 mr-96   ">
...
<div class=" bg-gray-100 p-6">
    <div class="flex space-x-6">
        ...
        <div class="ml-80   bg-white p-6 rounded-lg shadow-md w-1/3">
        ...
        <!-- Right Section (Order) -->
        <div class="-mr-60 bg-white p-6 rounded-lg shadow-md w-1/3">
