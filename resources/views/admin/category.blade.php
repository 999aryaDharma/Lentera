                            ...
                            <tbody class="">
                                <tr>
                                    <td
                                        ...
                                        <span
                                            class="text-xs font-semibold leading-tight text-slate-400">{{ $k->id }}</span>
                                    </td>

                                    <td
                                        class="p-2 text-center align-middle border-b whitespace-nowrap shadow-transparent">
                                        <span
                                            class="text-sm font-semibold leading-tight text-slate-400">{{ $k->category }}</span>
                                    </td>

                                    <td
                                        class="p-2 text-center align-middle border-b whitespace-nowrap shadow-transparent">
                                        <span
                                            class="text-sm font-semibold leading-tight text-slate-400">{{ $k->jumlah }}</span>
                                    </td>
                                    ...
                                    <td class="p-4 text-center border-b flex justify-center space-x-1">
                                        ...
                                        <button
                                            ...
                                            <a href="{{route('adminpage.category.edit',[$k->id])}}"
                                        ...
                                        <form action="{{route('adminpage.category.destroy',[$k->id])}}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
