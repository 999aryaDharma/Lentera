            ...
            <div
                ...
                <div class="flex p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    ...
                    <div class="flex items-center md:ml-auto md:pr-4">
                        ...
                        <form action="{{route('adminpage.searchProduct')}}" method="GET" class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
                            <span
                            ...
                            <tbody class="">
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <span
                                            class="text-sm font-semibold leading-normal text-gray-900">{{ $product->product }}</span>
                                    </td>
